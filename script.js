...
//     console.log(todaysPickArray.length);
// }
...
// const todayPickCategoryItemsDetails = (items) => {
//     let todaysPickArray = [];
//     let todaysTrendingArray = [];
//     items.forEach(item => {
//         if (item.others_info.is_todays_pick) {
...
//         }
//     })
//     console.log(todaysPickArray);
//     console.log(todaysTrendingArray);
